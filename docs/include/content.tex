...
\chapter{Remote development}
    ...
    You can either setup your development manually, as described in section \ref{sec:git_remote} and \ref{sec:quarkus_remote}. Otherwise you are able to use the provided ready-to-use Dockerfile in section \ref{sec:dockerfile}. \\
...
\section{How to set up Quarkus for remote development}\label{sec:quarkus_remote}
    This chapter is about setting up Quarkus in a Docker container \autocite[vgl.][]{quarkus}. If you have already completed the steps from chapter \ref{sec:git_remote}, you can continue with this container. Otherwise, you have to create a new container.
