...
\chapter{Requirements} 
    ...
    \section{Flow chart for calculation process}
        ...
        \begin{tikzpicture}[node distance = 2cm]
            ...
            \node [decision, fill=blue!20, below of=start, yshift=-2cm] (decision) {is Einschaltdauer set?};
            \node [process, fill=blue!20, right of=decision, xshift=4cm] (einschaltdauer) {Einschaltdauer = 100};
            \node [process, fill=blue!20, below of=decision, yshift=-2cm] (conversion) {conversion of geometric measures};
            ...
            \path [connector] (einschaltdauer) |- (conversion);
